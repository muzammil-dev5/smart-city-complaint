...
const AdminFeedback = () => {
    ...
    return (
        <Box className="adminFeedback">
            ...
            <Box className="adminFeedback-pageHeader">
            ...
            <Box className="adminFeedback-statsGrid">

                {/* Average Rating */}
                <Paper
                    elevation={0}
                    className="adminFeedback-statCard"
                >
                    ...
                    <Box className="adminFeedback-statContent">
                        ...
                        <Typography className="adminFeedback-statHint">
                            Out of 5.0 rating
                        </Typography>
                    </Box>
                </Paper>
            ...
            <Paper
                elevation={0}
                className="adminFeedback-card adminFeedback-chartCard"
            >
                ...
                <Box className="adminFeedback-cardHeader">
                    ...
                    <Box>
                        ...
                        <Typography className="adminFeedback-cardSubtitle">
                            Overview of how citizens rate their
            ...
            <Paper
                elevation={0}
                className="adminFeedback-card adminFeedback-feedbackCard"
            >
                ...
                <Box className="adminFeedback-sectionHeader">
                    ...
                    <Box>
                        ...
                        <Typography className="adminFeedback-cardSubtitle">
                            Review citizen ratings, comments and
                            complaint status.
                        </Typography>
                    </Box>
                ...
                <Box className="adminFeedback-filterWrapper">
                    ...
                    <Box className="adminFeedback-filters">
                        ...
                        <FormControl
                            size="small"
                            className="adminFeedback-ratingFilter"
                        >
                            <InputLabel>
                                Rating
                            </InputLabel>
                        ...
                        <TableBody>
                            ...
                            {filteredFeedback.length === 0 ? (
                                ...
                                filteredFeedback.map((item) => (
                                    ...
                                    <TableRow
                                        key={item._id}
                                        className="adminFeedback-tableRow"
                                    >
